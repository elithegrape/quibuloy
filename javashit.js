...
//2) Placeholders & List Management
...
function playRecentSong(recent) {
...
const playlists = {
    bben: [
        { title: 'lifetime', artist: 'Ben&Ben', src: 'songs/ben/lifetime.mp3', image: 'image/ben&ben/lifetime.jpg' },
        { title: 'Leaves', artist: 'Ben&Ben', src: 'songs/ben/leaves.mp3', image: 'image/ben&ben/leaves.jpg' },
        { title: 'autumn', artist: 'Ben&Ben', src: 'songs/ben/autumn.mp3', image: 'image/ben&ben/autumn.jpg' },
        { title: 'saranggola', artist: 'Ben&Ben', src: 'songs/ben/saranggola.mp3', image: 'image/ben&ben/saranggola.jpg' },
        { title: 'kathang isip', artist: 'Ben&Ben', src: 'songs/ben/kathang-isip.mp3', image: 'image/ben&ben/kathang-isip.jpg' }
    ],
    ft: [
        { title: 'kalapastangan', artist: 'Fitterkarma', src: 'songs/fitterkarma/kalapastangan.mp3', image: 'image/fitterkarma/kalapastangan.jpg' },
        { title: 'Pag-ibig ay kanibalismo', artist: 'Fitterkarma', src: 'songs/fitterkarma/kanibalismo.mp3', image: 'image/fitterkarma/kanibalismo.jpg' },
        { title: 'Sumpa', artist: 'Fitterkarma', src: 'songs/fitterkarma/sumpa.mp3', image: 'image/fitterkarma/sumpa.jpg' },
        { title: 'Pambihira', artist: 'Fitterkarma', src: 'songs/fitterkarma/pambihira.mp3', image: 'image/fitterkarma/pambihira.jpg' },
        { title: 'Isang pangako', artist: 'Fitterkarma', src: 'songs/fitterkarma/pangako.mp3', image: 'image/fitterkarma/pangako.jpg' }
    ],
    aljames: [
        { title: 'ngayong gabi', artist: 'Al James', src: 'songs/aljames/ngayon gabi.mp3', image: 'image/aljames/ngayon-gabi.jpg' },
        { title: 'pa umaga', artist: 'Al James', src: 'songs/aljames/paumaga.mp3', image: 'image/aljames/paumaga.jpg' },
        { title: 'pwede ba', artist: 'Al James', src: 'songs/aljames/pwedeba.mp3', image: 'image/aljames/pwedeba.jpg' },
        { title: 'pahinga', artist: 'Al James', src: 'songs/aljames/pahinga.mp3', image: 'image/aljames/pahinga.jpg' },
        { title: 'repeat', artist: 'Al James', src: 'songs/aljames/repeat.mp3', image: 'image/aljames/repeat.jpg' }
    ],
    janroberts: [
        { title: 'sagip', artist: 'Jan Robert S.', src: 'songs/jan-roberts/sagip.mp3', image: 'image/kalapastanagn.jpg' },
        { title: 'patlang', artist: 'Jan Robert S.', src: 'songs/jan-roberts/patlang.mp3', image: 'image/kalapastanagn.jpg' },
        { title: 'tanaw', artist: 'Jan Robert S.', src: 'songs/jan-roberts/tanaw.mp3', image: 'image/kalapastanagn.jpg' },
        { title: 'hirap kalimutan', artist: 'Jan Robert S.', src: 'songs/jan-roberts/hirap kalimutan.mp3', image: 'image/kalapastanagn.jpg' },
        { title: 'U-Belt', artist: 'Jan Robert S.', src: 'songs/jan-roberts/u-belt.mp3', image: 'image/kalapastanagn.jpg' }
    ],
...
function playTrack(list, index) {
    ...
    const sourceEl = audio.querySelector('source');
    if (sourceEl) sourceEl.src = encodeURI(track.src);
    audio.load();
    audio.play().catch(() => {});
